...
class Agent(object):
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions, max_mem_size=100000,
                 eps_min=0.01, eps_dec=0.996, target_iteration=200):
        self.gamma = gamma
        ...
        self.target_iteration_cntr = 0

        self.Q_eval = DeepQNetwork(lr, n_actions=self.n_actions, input_dims=input_dims, fc1_dims=256, fc2_dims=256)
        self.Q_target = DeepQNetwork(lr, n_actions=self.n_actions, input_dims=input_dims, fc1_dims=256, fc2_dims=256)
    ...
    def learn(self):
        if self.mem_cntr > self.batch_size:
            ...
            if self.target_iteration_cntr % self.target_iteration == 0:
                self.Q_target.load_state_dict(self.Q_eval.state_dict())
            self.target_iteration_cntr += 1
...
if __name__ == '__main__':
    ...
    brain = Agent(gamma=0.99, epsilon=1.0, batch_size=64, n_actions=4, input_dims=[8], lr=0.001, eps_dec=0.00003)
    ...
    plt.plot(scores)
    plt.savefig('deep_q_learning_with_target.png')
